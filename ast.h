...
#define AST_TYPES \
	...
	AST_TYPE_ENTRY(VAR) \
	AST_TYPE_ENTRY(DECLARE) AST_TYPE_ENTRY(DECLARE_ARRAY) \
	AST_TYPE_ENTRY(LOCALSIZE) \
	AST_TYPE_ENTRY(INSN) \
	AST_TYPE_ENTRY(RETURN) \
	AST_TYPE_ENTRY(SYSCALL) \
	AST_TYPE_ENTRY(FUNCPTR) \
	AST_TYPE_ENTRY(ARRAYREF) \
	AST_TYPE_ENTRY(ASSIGN_ARRAY_MEMBER) \
	...
	AST_TYPE_ENTRY(REF) \
	AST_TYPE_ENTRY(ARRAY_INIT) AST_TYPE_ENTRY(STRUCT_INIT)
...
typedef enum {
	...
	AST_RETURNS_CONST,
	AST_RETURNS_NUMBER,
	AST_RETURNS_OBJ, //pointer to array or struct
